      ...
      return Align(
        ...
        child: Transform.rotate(
            ...
            child: new SizedBox.fromSize(
              ...
              child: widget._cardBuilder(context, widget._totalNum - realIndex - 1, frontCardAlign.x * 2.0 / widget._totalMovementHorizontal),
            )),
      );
    }
    ...
    return Align(
      ...
      child: new SizedBox.fromSize(
        size: _animationController.status == AnimationStatus.forward && (frontCardAlign.x > 3.0 || frontCardAlign.x < -3.0 || frontCardAlign.y > 3 || frontCardAlign.y < -3)
            ...
            : _cardSizes[index],
        child: widget._cardBuilder(context, widget._totalNum - realIndex - 1, 0),
      ),
    );
  }
        ...
        onPanUpdate: (DragUpdateDetails details) {
          setState(() {
            if (widget._allowVerticalMovement == true) {
              frontCardAlign = new Alignment(frontCardAlign.x + details.delta.dx * widget._totalMovementHorizontal / MediaQuery.of(context).size.width,
                  frontCardAlign.y + details.delta.dy * 2 / MediaQuery.of(context).size.height);
            } else {
              frontCardAlign = new Alignment(frontCardAlign.x + details.delta.dx * widget._totalMovementHorizontal / MediaQuery.of(context).size.width, 0);
            }
